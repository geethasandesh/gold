...
function Adminheader() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-gradient-to-r from-yellow-500 via-yellow-600 to-yellow-500 shadow-lg rounded-b-2xl px-2 sm:px-0">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between py-4 px-4 sm:px-8">
        ...
        <div className="flex items-center space-x-2 sm:space-x-6 mt-4 sm:mt-0">
          <nav className="flex space-x-1 sm:space-x-4">
            <Link to="/admin/tokens" className="px-3 py-2 rounded-lg font-medium text-white hover:bg-yellow-800/80 transition">Tokens</Link>
            <Link to="/admin/gold-reserves" className="px-3 py-2 rounded-lg font-medium text-white hover:bg-yellow-800/80 transition">Gold Reserves</Link>
            <Link to="/admin/silver-reserves" className="px-3 py-2 rounded-lg font-medium text-white hover:bg-yellow-800/80 transition">Silver Reserves</Link>
            <Link to="/admin/file" className="px-3 py-2 rounded-lg font-medium text-white hover:bg-yellow-800/80 transition">File</Link>
            <Link to="/admin/reports" className="px-3 py-2 rounded-lg font-medium text-white hover:bg-yellow-800/80 transition">Reports</Link>
          </nav>
          ...
          <div className="relative">
            <button
              ...
              className="relative flex items-center justify-center w-10 h-10 rounded-full hover:bg-yellow-600/70 transition"
              title="Notifications"
            >
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white text-black rounded-xl shadow-2xl z-50 border border-yellow-200 animate-fade-in">
                ...
                <ul className="max-h-64 overflow-y-auto">
                  {notifications.length === 0 ? (
                    ...
                    <li key={notif.id} className="px-4 py-3 border-b hover:bg-yellow-100/80 cursor-pointer transition" onClick={() => handleNotifClick(notif)}>
                      {notif.message}
                    </li>
                  ))}
                </ul>
          ...
          <div>
            <button
              ...
              className="flex items-center space-x-2 bg-yellow-600 hover:bg-yellow-500 px-4 py-2 rounded-full transition shadow-md"
            >
              <span className="w-8 h-8 rounded-full bg-yellow-200 flex items-center justify-center text-yellow-800 font-bold text-lg border-2 border-yellow-400">
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-white rounded-2xl p-8 shadow-2xl max-w-sm w-full mx-4 border border-yellow-200 animate-fade-in">
            <h3 className="text-xl font-bold text-yellow-800 mb-4 flex items-center">
              <svg className="h-6 w-6 mr-2 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex justify-end space-x-3">
              <button
                ...
                className="px-4 py-2 text-yellow-700 hover:text-yellow-900 bg-yellow-100 hover:bg-yellow-200 rounded-lg transition font-medium"
              >
                Cancel
              </button>
              <button
                onClick={handleLogout}
                className="px-4 py-2 text-white bg-red-500 hover:bg-red-600 rounded-lg transition font-medium shadow"
              >
                Logout
              </button>
            </div>
